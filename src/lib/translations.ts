...
export const translations: Record<"ko" | "en" | "tr", TranslationSchema> = {
  ko: {
    ...
    mainTitle: "탄약지환통 전문 제조기업",
    mainTitleEng: "AMMUNITION FIBERBOARD CONTAINER SPECIALIST",
    mainSubtitle: "60년 이상 축적된 지관 제조 기술을 기반으로, 국방 K-방산 포장 분야에서 요구되는 품질과 신뢰성을 갖춘 탄약지환통을 생산합니다.",
    mainDesc: "수원지관산업은 탄약의 보관·수송·취급 과정에서 필요한 방습성, 내구성, 치수 안정성을 고려하여 탄약의 장기 저장성과 운송 안정성을 높이는 기능성 탄약지환통을 제조합니다.\n\n탄약의 가치는 안전한 보관에서 지켜집니다. 수원지관산업은 그 가치를 지키는 포장 기술에 집중합니다.",
    nav: {
      home: "HOME",
      products: "제품소개",
      simulator: "맞춤 규격 설계",
    ...
    footer: {
      desc: "수원지관산업은 탄약지환통 및 일반 산업용 지관 전문 제조기업으로, 수십 년 축적된 제조 및 정밀 절단 프레스 공법을 바탕으로 신뢰성 높은 최상의 제품 규격을 공급합니다.",
    ...
    home: {
      ...
      strengthLabel: "구조 강도",
      strengthVal: "고강도 다층 탄약지환통 성형 구조",
      qualityLabel: "품질 관리",
      ...
      industrialDesc: "탄약지환통 생산을 통해 확보한 초고횡압 분산 와인딩 기술을 기반으로 일반 산업 현장의 권취용 지관, 포장용 지관, 원단 권치용 종이 롤 등 다양한 민수용 제품군을 정밀 가공하여 공급합니다. 소형에서부터 수 미터에 달하는 대형 권취 구조체까지 완벽한 공차가 강점입니다.",
      indCat1: "소형 지관",
    ...
    ammo: {
      ...
      desc1: "수원지관산업은 60년 이상 축적된 지관 제조 기술을 기반으로, MIL-SPEC 및 KDS 8140-4005 국방규격의 요구 조건을 참고하여 탄약지환통을 생산하고 있습니다.",
      desc2: "원지 투입 및 지관 성형, 방습 처리, 정밀 절단, 금속 플랜지 및 칼라 조립, 보호 캡 조립에 이르는 제조 공정을 통해 탄약의 장기 저장성과 운송 안정성을 높이는 탄약지환통을 제작합니다.",
    ...
    stockPage: {
      ...
      desc: "수원지관산업에서 현재 공급 가능한 탄약지환통, 일반 산업용 지관, 샘플 지관 및 기타 지관류 제품을 확인하고 문의하실 수 있습니다.\n제품별 공급 가능 수량, 단가, 납기 조건은 담당자 확인 후 안내되며, 거래는 견적서 및 전자세금계산서 발행 방식으로 진행됩니다.",
    ...
    qualityPage: {
      ...
      title: "품질 및 정밀 제조 공정",
      desc: "전비 태세에 직결되는 서열 무결 보전 탄약지환통 제조를 위해, 원재료 입고 수입 검사부터 나선 성형 각도 산출, 고온 건조 방습 증폭, 기밀 전수 진공 검사까지 한 치의 타협도 없는 전 공정 치수 보증을 이어가고 있습니다.",
    ...
    referencePage: {
      ...
      descBold: "수원지관산업은 60여 년간 축적해 온 지관 제조 기술과 품질관리 경험을 바탕으로 탄약지환통 및 산업용 지관 분야에서 안정적인 제품을 공급해 왔습니다.",
      ...
      section2Desc: "풍산, 한화 에어로스페이스 등 국내외 대표 종합 체계 업체에 군용 탄약지환통 및 포장 보관 용기 부품들을 정밀 공급해 왔습니다.",
